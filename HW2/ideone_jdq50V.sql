...
CREATE TABLE Test( test_id INTEGER NOT NULL,  employee_id INTEGER NOT NULL,
				   ...
				   test_result char(20), 
				   row_id INTEGER NOT NULL REFERENCES Symptom(row_id),
...
INSERT INTO Symptom VALUES (50,101,'10.02.2021',1);
INSERT INTO Symptom VALUES (51,102,'10.02.2021',1);
INSERT INTO Symptom VALUES (52,103,'10.02.2021',2);
INSERT INTO Symptom VALUES (53,104,'10.02.2021',4);
INSERT INTO Symptom VALUES (53,105,'10.02.2021',3);
INSERT INTO Symptom VALUES (54,106,'10.02.2021',1);
...
--SELECT count(floor_number) as sickest ,floor_number 
